#include "stdafx.h"
#include "graph_intersection.hpp"
...
//
//	//Intersection(G1, G2, og, pm_edge_names_g1, pm_edge_names_g2, pm_vertex_names_g1, pm_vertex_names_g2, pm_vertex_names_og, pm_edge_names_og); 
//	//Intersection(G1, G2, og, pm_edge_names_g1, pm_edge_names_g2, pm_edge_names_og); 
//	Intersection(G1, G2, og, pm_vertex_names_g1, pm_vertex_names_g2, pm_vertex_names_og); 
//	//Intersection(G1, G2, og); 
//
//	// Print Graph og
//	std::cout << "Graph Intersection : " << std::endl;
