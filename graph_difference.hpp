		...
		) 
{
	...
	boost::associative_property_map<std::map<graph_traits<Graph1>::edge_descriptor, std::string> > name_g1(e_names_g1);
	...
	boost::associative_property_map<std::map<graph_traits<Graph2>::edge_descriptor, std::string> > name_g2(e_names_g2);
		...
		)
{
	...
	boost::associative_property_map<std::map<graph_traits<Graph1>::vertex_descriptor, std::string> > v_prop_g1(v_names_g1);
	...
	boost::associative_property_map<std::map<graph_traits<Graph2>::vertex_descriptor, std::string> > v_prop_g2(v_names_g2);
...
bool Difference( const Graph1& g1, const Graph2& g2, OutGraph& og) {
	...
	std::map<graph_traits<Graph1>::edge_descriptor, std::string> e_names_g1;
	boost::associative_property_map<std::map<graph_traits<Graph1>::edge_descriptor, std::string> > e_prop_g1(e_names_g1);
	...
	i = 0;
	std::map<graph_traits<Graph2>::edge_descriptor, std::string> e_names_g2;
	boost::associative_property_map<std::map<graph_traits<Graph2>::edge_descriptor, std::string> > e_prop_g2(e_names_g2);
	for (tie(ei2_start, ei2_end) = edges(g2) ; ei2_start != ei2_end ; ++ei2_start, i++){		
