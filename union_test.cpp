...
//
//	Union(G1, G2, og, pm_edge_names_g1, pm_edge_names_g2, pm_vertex_names_g1, pm_vertex_names_g2, pm_vertex_names_og, pm_edge_names_og); 
//	//Union(G1, G2, og, pm_edge_names_g1, pm_edge_names_g2, pm_edge_names_og); 
//	//Union(G1, G2, og, pm_vertex_names_g1, pm_vertex_names_g2, pm_vertex_names_og); 
//	//Union(G1, G2, og); 
//
//	print_graph(og,pm_vertex_names_og);
//	//print_graph(og,pm_edge_names_og);
//	// Print Graph og
//	std::cout << "Graph Union : " << std::endl;
//	graph_traits<MyGraphType>::edge_iterator ei1_start,ei1_end;	
//	for(tie(ei1_start,ei1_end)=boost::edges(og); ei1_start != ei1_end; ++ei1_start ){				
//		std::cout<<"Edge Name: " << get(pm_edge_names_og,*ei1_start)<<" ";
